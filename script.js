...
function updateProgress() {
    ...
    document.querySelectorAll(".work-table td:not(:first-child)").forEach(cell => {
    ...
    if (percent === 0) {
        ...
        progressMessage.innerText = "👍 Good Start!";
    }
    else if (percent <= 50) {
        progressMessage.innerText = "💪 Keep Going!";
    }
    else if (percent <= 75) {
        progressMessage.innerText = "🔥 You're doing great!";
    }
    else if (percent < 100) {
        progressMessage.innerText = "🚀 Almost Done!";
    }
    else {
        progressMessage.innerText = "🎉 Amazing! All Tasks Completed!";
    }
}
